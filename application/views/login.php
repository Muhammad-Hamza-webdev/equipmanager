            ...
            <div class="inner-login">
                <form method="post" class="form" action="<?= base_url('login-data') ?>">
                    ...
                    <div class="main-box">
                        ...
                        <span class="sub-heading">Sign in to access your account and continue your journey.</span>
                        <div class="inputs">
                        ...
                        <div class="fot-pass">
                            <a href="<?=base_url('forgot-password')?>"> Forgot Password </a> <span>|</span> <a
                                href="<?=base_url('register')?>"> Sign Up </a>
                        </div>
                        <div>
