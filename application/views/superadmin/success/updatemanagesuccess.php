...
<head>
    ...
    <title>Update Success Metrics</title>
</head>
                        ...
                        <div class="card-body">
                            <div class="border p-4 rounded">
                                <div class="card-title d-flex align-items-center">
                                    <h5 class="mb-0">Update Success Metrics</h5>
                                </div>
                                <hr />
                                <?php foreach ($successData as $sucesData) { ?>
                                    <form action="<?= base_url('process-update-success/' . $sucesData['web_successID']) ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <!-- Show current icon -->
                                                <?php if (!empty($sucesData['web_successIcon'])) { ?>
                                                    <div class="mt-2 bg-dark-green">
                                                        <small>Current Icon:</small>
                                                        <img src="<?= base_url('assets/uploads/superadmin/success-metrics/' . $sucesData['web_successIcon']) ?>" alt="icon" style="width: 50px; height: 50px; object-fit:cover" class="ms-2">
                                                    </div>
                                                <?php } ?>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input
                                                    ...
                                                    name="sucesTitle"
                                                    required
                                                    value="<?= $sucesData['web_successName'] ?>"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea
                                                    ...
                                                    rows="3"
                                                    required
                                                    placeholder="Write Success Description"><?= $sucesData['web_successDes'] ?></textarea>
                                            </div>
                                        </div>
                                        <div class="row">
